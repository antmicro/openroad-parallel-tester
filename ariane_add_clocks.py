...
and modifies the path to said file in the config file

USAGE: python3 ariane_add_clocks.py <path to ariane.sdc> <path to config.mk>
"""
...
if len(sys.argv) < 3:
    print("USAGE: python3 ariane_add_clocks.py <path to ariane.sdc> <path to config.mk>")
    exit()
